...
class Ej7 extends EjGenerico{
    ...
    constructor () {
        super(
            ...
            'Escribe los 4 primeros múltiplos del siguiente números, sin contar al 0', 
            [Math.floor(Math.random() * (24999 - 2 + 1) + 2).toString()], //numero random entre 2 y 24999
            10
        )
    }
    ...
    resolver(input){ //el input es un array de 4 strings
        ...
        this.resultado.push(this.obtener_multiplos(num,4)) //porque quiero los 4 primeros numeros

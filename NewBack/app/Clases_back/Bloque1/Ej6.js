...
class Ej6 extends EjGenerico{
    constructor () {
        super(
            ...
            'Redondea el siguiente número a las decenas, las centenas, las unidades de millar y las decenas de millar.', 
            [Math.floor(Math.random() * (999999 - 100000 + 1) + 100000).toString()], //numero random entre 100000 y 999999
            10
        )
    }

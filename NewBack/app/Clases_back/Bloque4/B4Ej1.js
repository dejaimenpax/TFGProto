...
class B4Ej1 extends EjGenerico {
  constructor(
    ...
    "y cual es la edad media de la clase (redondeada a la décima).",
    ...
    this.long_input = 2;
    this.etiquetas= ["Alumnos totales:", "Media de edad (redondeada a la décima):"]
  ...
  resolver(input) {
    ...
    let media = (sumaEdades/totalAlumnos)
